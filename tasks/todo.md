...
- [ ] **P2 multi-page expansion** — IN REVIEW (PR pending): 8 pages built (/case-studies/ + 3 deep-dives, /services/enterprise-seo, /services/geo, /about, /contact), sitemap 3→11 URLs, homepage links, verify-site coverage. Merge = copy approval (all claims recombine already-published material). **Deferred:** /security page — needs owner facts: E&O/cyber insurance status, legal entity, data-handling + AI-tool policy, continuity statement. **Deferred:** forwardable case-study PDF (build after deep-dive copy is approved).
